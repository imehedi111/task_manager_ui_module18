...
import 'package:task_management_project_module18/ui/providers/update_profile_provider.dart';
...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
                  ...
                  children: [
                    ...
                    Consumer<UpdateProfileProvider>(
                      builder: (context, updateProfileProvider, _) {
                        return Visibility(
                          visible: updateProfileProvider.updateInProgress == false,
  ...
  Future<void> _updateProfile() async {
    ...
    final bool isSuccess = await _updateProfileProvider.updateProfile(
        ...
        password: _paswordTeController.text,
